...
**_Maintaining the CNN is one very important practise that I will try to inculcate, also the testing will be more appropriate trying to cover all the boundaries. Namin of the functions also has equal importance since readbility of the code is one main point**
